...
from owl.core.handlers import HandlerDispatcher
...
from owl.utils.formatting import format_project_id
...
class Poller:
    ...
    def __init__(
        ...
        self.lock = PollLock(owl_dir / "poll.lock")
        self._offset_file = owl_dir / "telegram_offset"
        self._offset: Optional[int] = self._load_offset()
        self._running = False
        self._debug_log = owl_dir / "subagent_debug.log"
